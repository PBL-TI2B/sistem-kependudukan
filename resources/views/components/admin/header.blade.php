<header class="sticky top-0 inset-x-0 flex flex-wrap md:justify-start md:flex-nowrap z-48 w-full bg-white border-b border-gray-200 text-sm py-2.5 lg:ps-65 dark:bg-neutral-800 dark:border-neutral-700">
    <nav class="px-4 sm:px-6 flex basis-full flex-wrap justify-between items-center w-full mx-auto">
      <div class="me-5 lg:me-0 lg:hidden gap-4 flex items-center">
         <!-- Navigation Toggle -->
        ...
        <!-- Logo -->
        <a class="dark:text-white flex-none rounded-md text-xl inline-block font-semibold focus:outline-hidden focus:opacity-80" href="#" aria-label="Desa Jabung">
          Desa Jabung
        </a>
        <!-- End Logo -->
