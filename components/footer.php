  ...
  <footer class="bg-[#0B391D] text-white px-6 py-8">
    <div class="max-w-7xl mx-auto grid grid-cols-3 md:grid-cols-3 gap-8">
      ...
      <div class="text-sm">
        ...
        <ul class="space-y-1">
          <li><a href="#" class="hover:underline">Website Kecamatan Gantiwarno</a></li>
          <li><a href="#" class="hover:underline">Website Kabupaten Klaten</a></li>
        </ul>
      </div>
    ...
    <!-- Copyright -->
    <div class="mt-6 border-t border-gray-400 pt-4 text-center text-xs text-white">
      <p>&copy; Team-1 PBL</p>
    </div>
  </footer>
