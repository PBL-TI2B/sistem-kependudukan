...
var init_vanilla_calendar_pro = __esm({
  "node_modules/vanilla-calendar-pro/index.mjs"() {
    ...
    hide2 = (e2) => {
      e2.context.currentType && (e2.context.mainElement.dataset.vcCalendarHidden = "", e2.onHide && e2.onHide(e2));
    };
    handleDay = (e2, t, n, a) => {
      var l;
...
`;
  ...
  `), handleTime(e2, t);
    ...
    handleArrowKeys = (e2) => {
      const t = () => Array.from(e2.context.mainElement.querySelectorAll('[data-vc="calendar"] button'));
      let n = 0;
      const a = { ArrowUp: (e3, t2) => Math.max(0, e3 - t2), ArrowDown: (e3, n2) => Math.min(t().length - 1, e3 + n2), ArrowLeft: (e3) => Math.max(0, e3 - 1), ArrowRight: (e3) => Math.min(t().length - 1, e3 + 1) }, l = (e3) => {
        var l2, o;
        if (!a[e3.key] || "button" !== (null == (l2 = e3.target) ? void 0 : l2.localName)) return;
        const s = t(), i = s[n].hasAttribute("data-vc-date-btn") ? 7 : s[n].hasAttribute("data-vc-months-month") ? 4 : s[n].hasAttribute("data-vc-years-year") ? 5 : 1;
        n = a[e3.key](n, i), null == (o = s[n]) || o.focus();
      };
      return e2.context.mainElement.addEventListener("keydown", l), () => {
        e2.context.mainElement.removeEventListener("keydown", l);
      };
    };
    handleMonth = (e2, t) => {
    ...
    createToInput = (e2, t = true) => {
      const n = document.createElement("div");
      return n.className = e2.styles.calendar, n.dataset.vc = "calendar", n.dataset.vcInput = "", n.dataset.vcCalendarHidden = "", n.style.visibility = "hidden", setContext(e2, "inputModeInit", true), setContext(e2, "mainElement", n), document.body.appendChild(e2.context.mainElement), t && queueMicrotask(() => {
        setPosition(e2.context.inputElement, n, e2.positionToInput), e2.context.mainElement.style.visibility = "visible", e2.show();
      }), reset(e2, { year: true, month: true, dates: true, time: true, locale: true }), e2.onInit && e2.onInit(e2), handleArrowKeys(e2), handleClick(e2);
    };
    handleInput = (e2) => {
      const t = [];
      setContext(e2, "inputElement", e2.context.mainElement);
      const n = () => setPosition(e2.context.inputElement, e2.context.mainElement, e2.positionToInput), a = (t2) => {
        var n2, l2;
        "Escape" === t2.key && ((null == (n2 = null == e2 ? void 0 : e2.context) ? void 0 : n2.inputElement) && (null == (l2 = null == e2 ? void 0 : e2.context) ? void 0 : l2.mainElement) && e2.hide(), document.removeEventListener("keydown", a));
      }, l = (t2) => {
        e2 && t2.target !== e2.context.inputElement && !e2.context.mainElement.contains(t2.target) && (e2.context.inputElement && e2.context.mainElement && e2.hide(), window.removeEventListener("resize", n), document.removeEventListener("click", l, { capture: true }));
      }, o = () => {
        e2.context.inputModeInit ? (setPosition(e2.context.inputElement, e2.context.mainElement, e2.positionToInput), e2.context.mainElement.style.visibility = "visible", e2.show()) : t.push(createToInput(e2)), window.addEventListener("resize", n), document.addEventListener("click", l, { capture: true }), document.addEventListener("keydown", a);
      };
      return e2.context.inputElement.addEventListener("click", o), e2.context.inputElement.addEventListener("focus", o), () => {
        t.forEach((e3) => e3());
      };
    };
    ...
    show = (e2) => {
      e2.context.currentType ? (e2.context.mainElement.removeAttribute("data-vc-calendar-hidden"), e2.onShow && e2.onShow(e2)) : e2.context.mainElement.click();
    };
