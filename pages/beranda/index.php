 ...
 <?php
  ...
  <main class="main">
    ...
    <div class="relative z-10 -mt-60 mx-5">
      <div class="px-6 py-6 max-w-6xl mx-auto md:px-auto flex justify-center items-center text-white" style="background-image: url('../../src/ellipseStat.svg'); background-size: contain; background-repeat: no-repeat; background-position: center; min-height: 475px;">
      ...
      <div class="mx-4 max-w-6xl lg:mx-auto">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-5">
          ...
          <div class="flex flex-col gap-4 justify-between">
            ...
            <img src="../../src/berita-lain.png" class="w-32 h-20 md:w-64 md:h-36 object-cover rounded-sm md:rounded-lg" alt="Berita kecil">
              <div>
